...
const ShowProjectList = () => {
  ...
  const handleUpdateProject = async () => {
    try {
      await fetch(
        `http://localhost:5000/projects/update/${selectedProject.project_id}`,
        {
          method: "PUT",
        ...
        <Modal.Body>
          <Form>
            <Form.Group className="mb-3">
              ...
              <Form.Control
                as={
                  updatedProject.project_name.length > 50 ? "textarea" : "input"
                }
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control
                as={
                  updatedProject.description.length > 50 ? "textarea" : "input"
                }
